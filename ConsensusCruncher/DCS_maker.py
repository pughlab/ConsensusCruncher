...
# --bpdelim BarcodesDelimiter   Delimiter betwen barcode pair in read name, if --bdelim is not '|'
# --qdelim QnameDelimiter       Delimiter in query read name created by ConsensusCruncher (NOT ':'), if --bdelim is not '|'
#
# Inputs:
...
def main():
    ...
    parser.add_argument("--bpdelim", action="store", dest="bpdelim", help="Delimiter betwen barcode pair in read name, if --bdelim is not '|'",
                        required=False, type=str)
    parser.add_argument("--qdelim", action="store", dest="qdelim", help="Delimiter in query read name created by ConsensusCruncher (NOT ':'), if --bdelim is not '|'",
                        required=False, type=str)

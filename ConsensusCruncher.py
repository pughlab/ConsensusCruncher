...
if __name__ == '__main__':
    ...
    bpdelim_help = "Delimiter betwen barcode pair in read name, if --bdelim is not '|'" \
                  "(e.g. '.' in 'HWI-D00331:196:C900FANXX:7:1110:14056:43945|TT.TT')"
    qdelim_help = "Delimiter in query read name created by ConsensusCruncher (NOT ':'), if --bdelim is not '|'" \
